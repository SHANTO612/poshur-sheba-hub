...
import Cart from '../../components/business/users/Cart';
...
const Feed = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log('Fetching products from:', `${API_BASE_URL}/products?type=feed,equipment`);
        ...
        if (productsResult.success) {
          console.log('Products fetched successfully:', productsResult.data);
  ...
  const handleProductAdded = () => {
    ...
    fetch(`${API_BASE_URL}/products?type=feed,equipment`)
      ...
      .then(result => {
        if (result.success) {
          console.log('Products refreshed successfully:', result.data);
          setProducts(result.data);
        } else {
          console.error('Error refreshing products:', result.message);
        }
      })
      .catch(error => {
